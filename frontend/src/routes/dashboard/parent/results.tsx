  ...
  return (
    <div className="print:bg-white">
      <div className="mb-6 flex gap-3 print:hidden">
        <button onClick={() => window.print()} className="flex items-center gap-2 rounded-lg bg-evergreen px-5 py-2.5 text-sm font-semibold text-white hover:bg-evergreen-deep">
      ...
      {!loadingResult && result && (
        <>
          ...
          <div className="mb-5 overflow-x-auto rounded-2xl border border-ulead-line bg-chalk-card p-5">
